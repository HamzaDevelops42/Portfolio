                ...
                <Tooltip >
                    <TooltipTrigger asChild>
                        <a href={socials[0].link} target="_blank" rel="noopener noreferrer">
                            <Button
                                variant="secondary"
                                className="cursor-pointer w-24 h-full flex items-center justify-center bg-[var(--bg-button)] text-[var(--text)] border-[var(--my-border)] rounded-md hover:bg-[var(--bg-button-hover)] transition-colors hover:text-[var(--bg-button)]"
                            >
                                {socials[0].icon}
                            </Button>
                        </a>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <a href={socials[1].link} target="_blank" rel="noopener noreferrer">
                                        <Button
                                            variant="secondary"
                                            className="cursor-pointer w-26 h-full flex items-center justify-center bg-[var(--bg-button)] text-[var(--text)] border-[var(--my-border)] rounded-md hover:bg-[var(--bg-button-hover)] transition-colors hover:text-[var(--bg-button)]"
                                        >
                                            {socials[1].icon}
                                        </Button>
                                    </a>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <a href={socials[3].link} target="_blank" rel="noopener noreferrer">
                                    <Button
                                        variant="secondary"
                                        className="cursor-pointer w-full h-full flex items-center justify-center bg-[var(--bg-button)] text-[var(--text)] border-[var(--my-border)] rounded-md hover:bg-[var(--bg-button-hover)] transition-colors hover:text-[var(--bg-button)]"
                                    >
                                        {socials[3].icon}
                                    </Button>
                                </a>
